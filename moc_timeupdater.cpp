/****************************************************************************
** Meta object code from reading C++ file 'timeupdater.h'
**
...
#error "The header file 'timeupdater.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 7), // "shutOff"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "updateTime"
QT_MOC_LITERAL(4, 32, 9), // "onShutOff"
QT_MOC_LITERAL(5, 42, 3) // "run"

    },
    "TimeUpdater\0shutOff\0\0updateTime\0"
    "onShutOff\0run"
};
...
void TimeUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TimeUpdater::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeUpdater::shutOff)) {
                *result = 0;
                return;
            }
        }
